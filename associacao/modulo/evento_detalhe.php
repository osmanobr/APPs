           <?php
                ...
                ev.data
                from tb_evento ev
                inner join tb_categoria c on(c.id=ev.id_categoria) limit 1;";
...
<section class="page-title" style="background-image:url(images/background/page-t.jpg)">
            <div class="container">
               <div class="outer-box">
                  <h1><?php echo $ev['titulo']?></h1>
                  <ul class="bread-crumb clearfix">
                     <li><a href="index.php">Início</a></li>
                      <li><a href="?modulo=evento">Evento</a></li>
                     <li class="active"><?php echo $ev['titulo']?></li>
                  </ul>
               </div>
            </div>
         </section>
