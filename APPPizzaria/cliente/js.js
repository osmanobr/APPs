	...
	$(document).ready(function(){
     $('#add_more').on('click', function(){
      ...
      var html ='<!--<div id="append_no_'+i+'" class="animated bounceInLeft">'+
		  ...
		  '</div>'+
		  '<input type="text" name="campo_'+i+'" placeholder="Nome"  class="form-control"/>'+
		  '</div>'+
		  '<div class="input-group mt-3">'+
		  '<div class="input-group-prepend">'+
		  '<span class="input-group-text br-15" style="color:rgb('+colorR+','+colorG+','+colorB+'">'+
		  ...
		  '</div>'+
		  '<input type="text"  name="campo_'+i+'" placeholder="Celular" class="form-control"/>'+
		  '</div>'+
		  '<div class="input-group mt-3">'+
		  '<div class="input-group-prepend">'+
		  '<span class="input-group-text br-15" style="color:rgb('+colorR+','+colorG+','+colorB+'">'+
		  ...
		  '</div>'+
		  '<input type="email" name="campo_'+i+'" placeholder="Email" class="form-control"/>'+
		  '</div></div>-->';
