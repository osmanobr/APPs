         ...
         <section class="about grey-bg">
            <div class="container">
               ...
               <div class="sec-title centered">
                  <h1>Downloads</h1>
                  <h2>Acesse Nossos Documentos</h2>
...
foreach ($rows2 as $r){
?>                   
                  <div class="about-block-one col-lg-2 col-md-4">
                     <div class="inner-box"><?php echo $r['titulo'];?>
                        <div class="icon-box"><span class="flaticon-graphic"></span></div>
                        <h4><a href="?modulo=pagina&q=<?php echo $r['id'];?>">Down <?php echo $r['id'];?></a></h4>
                        <div class="link-btn"><a href="?modulo=pagina&q=<?php echo $r['id'];?>" class="theme-btn btn-style-two">Baixar</a></div>
                     </div>
                  </div>
<?php } } ?>
<!--
