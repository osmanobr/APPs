...
require_once __DIR__ . '/../models/Evento.php'; // Para buscar organizadores
...
// Recuperar dados do formulário em caso de erro (opcional)
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="<?php echo APP_URL; ?>/admin/evento_criar.php" class="nav-link active"><i class="far fa-circle nav-icon"></i> <p>Criar Evento</p></a></li>
            </ul>
          </li>
          <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-8 offset-md-2">
            <div class="card card-primary">
              <div class="card-header"><h3 class="card-title">Dados do Novo Evento</h3></div>
              <!-- /.card-header -->
              <form action="<?php echo APP_URL; ?>/controllers/EventoController.php" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="organizador_id" name="organizador_id">
                      ...
                      <?php foreach ($organizadores as $organizador): ?>
                        <option value="<?php echo escape_html($organizador['id']); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Detalhes sobre o evento..."></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
...
$(function () {
  ...
  $("#data_fim").on("change", function() {
    ...
    if (startDate && endDate && new Date(endDate) < new Date(startDate)) {
      ...
      $(this).val(''); // Limpa o campo inválido
    }
  });
  $("#data_inicio").on("change", function() {
    // Forçar revalidação da data final se a inicial mudar
