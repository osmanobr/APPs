<?php
$page_title = "Criar Novo Apartamento";
require_once __DIR__ . '/../views/partials/header.php';
require_once __DIR__ . '/../models/Apartamento.php'; // Para buscar hotéis e usuários

protect_page('admin');

$apartamentoModel = new Apartamento();
$hoteis = $apartamentoModel->getAllHoteisSimple();
$usuarios = $apartamentoModel->getPotenciaisUsuarios(); // Para vendedor e responsável
...
// $form_data = $_SESSION['form_data_apartamento'] ?? [];
// unset($_SESSION['form_data_apartamento']);
?>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="<?php echo APP_URL; ?>/admin/apartamento_criar.php" class="nav-link active"><i class="far fa-circle nav-icon"></i> <p>Criar Apartamento</p></a></li>
            </ul>
          </li>
          <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-10 offset-md-1">
            <div class="card card-primary">
              <div class="card-header"><h3 class="card-title">Dados do Novo Apartamento</h3></div>
              <form action="<?php echo APP_URL; ?>/controllers/ApartamentoController.php" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_apartamento" name="numero_apartamento" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_piso" name="numero_piso">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" step="0.01" min="0" class="form-control" id="valor_diaria" name="valor_diaria" required>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="vendedor_id" name="vendedor_id">
                          ...
                          <?php foreach ($usuarios as $usuario): ?>
                            <?php // Filtrar para mostrar apenas vendedores ou admins como opção
                                if (in_array($usuario['nivel_acesso'], ['vendedor', 'admin'])): ?>
                                <option value="<?php echo escape_html($usuario['id']); ?>">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="responsavel_id">Responsável Inicial</label>
                        <select class="form-control" id="responsavel_id" name="responsavel_id">
                         ...
                         <small class="form-text text-muted">Pode ser um inquilino (a ser cadastrado depois) ou um usuário do sistema.</small>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Salvar Apartamento</button>
...
<!-- Select2 (opcional, para melhores selects) -->
...
$(document).ready(function() {
    ...
    $('#tipo_acomodacao').select2({ theme: 'bootstrap4', placeholder: "Selecione o Tipo", minimumResultsForSearch: Infinity }); // Infinity para esconder busca
});
</script>
</body>
</html>
