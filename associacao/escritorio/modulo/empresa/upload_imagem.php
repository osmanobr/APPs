<?php
$rec = '';
if (isset($_FILES["tx_uplogo"])){
    $arquivo = $_FILES["tx_uplogo"];
    $rec = 'logo';
}
if (isset($_FILES["tx_upbanner1"])){
    $arquivo = $_FILES["tx_upbanner1"];
    $rec = 'banner';
}
if (isset($_FILES["tx_upbanner2"])){
    $arquivo = $_FILES["tx_upbanner2"];
    $rec = 'banner2';
}
if (isset($_FILES["tx_upbanner3"])){
    $arquivo = $_FILES["tx_upbanner3"];
    $rec = 'banner3';
}
    ...
    if (!empty($arquivo["name"])) {
        ...
        $tamanho = 1000000;
            ...
            $diretorio_imagem = '../../../images/empresa/';            
